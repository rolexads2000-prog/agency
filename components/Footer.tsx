...
const Footer: React.FC<FooterProps> = ({ onOpenPrivacy, onOpenTerms }) => {
  ...
  return (
    <footer className="relative bg-[#050505] border-t border-white/5 pt-20 pb-10 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-px bg-gradient-to-r from-transparent via-rolex-red/50 to-transparent opacity-50" />
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-rolex-navy/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <a href="#" className="block">
                <img src="/rolexadslogo.png" alt="Rolex Ads" className="h-10 md:h-12 w-auto object-contain" />
            </a>
            <p className="text-gray-400 text-sm font-medium leading-relaxed max-w-xs uppercase tracking-wide">
                {t.tagline}
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm text-gray-400">
                <li className="flex items-start gap-3 group">
                    <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center shrink-0 text-rolex-red mt-[-2px] group-hover:bg-rolex-red/10 transition-colors">
                        <MapPin size={16} />
                    </div>
                    <span className="leading-relaxed group-hover:text-gray-300 transition-colors">725M+82F, TP Nagar,<br/>Singarayakonda, AP 523101</span>
                </li>
                <li className="flex items-center gap-3 group">
                    <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center shrink-0 text-rolex-red group-hover:bg-rolex-red/10 transition-colors">
                        <Phone size={16} />
                    </div>
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noreferrer" className="hover:text-white transition-colors">9392556976</a>
                </li>
                <li className="flex items-center gap-3 group">
                    <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center shrink-0 text-rolex-red group-hover:bg-rolex-red/10 transition-colors">
                        <Mail size={16} />
                    </div>
                    <a href="mailto:rolexads@gmail.com" className="hover:text-white transition-colors">rolexads@gmail.com</a>
                </li>
            </ul>
          </div>
        </div>
